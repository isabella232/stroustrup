...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Profile_addition'
        db.create_table(u'profile_profile_addition', (
        ...
        db.send_create_signal(u'profile', ['Profile_addition'])


    def backwards(self, orm):
        # Deleting model 'Profile_addition'
        db.delete_table(u'profile_profile_addition')
