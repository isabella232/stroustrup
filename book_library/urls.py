...
urlpatterns = patterns('',
                       ...
                       url(r'^add_tag/$', TagAdd.as_view(success_url="/",
                                                              template_name="add_author_or_tag.html",
                                                              ),
                           name='add_tag'),
                       ...
                       url(r'^tags/(?P<pk>\d+)/$', TagView.as_view(model=Book_Tag,
                           ...
                           name='tag'),
                       url(r'^(?P<pk>\d+)/$', BookView.as_view(template_name="book.html",
                                                         ),
                           name='book'),
                       ...
                       url(r'^(?P<pk>\d+)/story/$', BookStoryListView.as_view(template_name='book_story.html',
                                                                    ),
                           name='story'),
                       url(r'^(?P<pk>\d+)/ask_to_return/(\d+)$', ask_to_return,
                           name='ask'),
                       #SpaT_edition v
                       url(r'^request/(?P<page>\d+)?/?$', requestBook.as_view(success_url='//',
                           #model=Book_Request,
