...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Book_Request.book_image_url'
        db.alter_column(u'book_library_book_request', 'book_image_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, null=''))

        # Changing field 'Book_Request.book_title'
        db.alter_column(u'book_library_book_request', 'book_title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        ...
        # Changing field 'Book_Request.book_authors'
        db.alter_column(u'book_library_book_request', 'book_authors', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Book_Request.book_price'
        db.alter_column(u'book_library_book_request', 'book_price', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Book_Request.book_image_url'
        db.alter_column(u'book_library_book_request', 'book_image_url', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Book_Request.book_title'
        db.alter_column(u'book_library_book_request', 'book_title', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Book_Request.title'
        db.alter_column(u'book_library_book_request', 'title', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Book_Request.book_authors'
        db.alter_column(u'book_library_book_request', 'book_authors', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Book_Request.book_price'
        db.alter_column(u'book_library_book_request', 'book_price', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
