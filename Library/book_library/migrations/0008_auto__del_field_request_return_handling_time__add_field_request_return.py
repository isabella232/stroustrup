...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Request_Return.handling_time'
        db.delete_column(u'book_library_request_return', 'handling_time')

        # Adding field 'Request_Return.processing_time'
        db.add_column(u'book_library_request_return', 'processing_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Request_Return.handling_time'
        db.add_column(u'book_library_request_return', 'handling_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Request_Return.processing_time'
        db.delete_column(u'book_library_request_return', 'processing_time')
