...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Request_Return.processing_time'
        db.alter_column(u'book_library_request_return', 'processing_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Request_Return.processing_time'
        raise RuntimeError("Cannot reverse this migration. 'Request_Return.processing_time' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Request_Return.processing_time'
        db.alter_column(u'book_library_request_return', 'processing_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
