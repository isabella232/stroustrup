...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Request_Return.handling_time'
        db.alter_column(u'book_library_request_return', 'handling_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Request_Return.handling_time'
        raise RuntimeError("Cannot reverse this migration. 'Request_Return.handling_time' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Request_Return.handling_time'
        db.alter_column(u'book_library_request_return', 'handling_time', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'book_library.request_return': {
            ...
            'book': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['book_library.Book']"}),
            'handling_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
