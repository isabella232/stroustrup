...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Book.book_table'
        db.add_column(u'book_library_book', 'book_table',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Book.book_table'
        db.delete_column(u'book_library_book', 'book_table')
    ...
    models = {
        ...
        u'book_library.book': {
            ...
            'book_table': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
